    ...
    >
      <div className='flex flex-col justify-center w-full h-full gap-4 md:flex-row'>
        <div className='flex flex-col items-center justify-center'>
          <h1 className='font-bold text-center text-main-1 px-1 w-full sm:px-0 sm:w-4/5 md:w-2/3 text-7xl break-words	'>{title || <> David&apos;s Devel - <span className='text-accent-1'>Blog</span></>}</h1>
